...
#token="3JeMmKh2ZGHkhUyDqF3Vn_49cUjBvPNwymVYWNYiAZ9"
...
banner() {
    ...
    printf "  ______              __ _           \n"
    printf " |  ____|            / _(_)          \n"
    printf " | |__ _ __ ___  ___| |_ _ _ __ ___  \n"
    printf " |  __| '__/ _ \/ _ \  _| | '__/ _ \\ \n"
    printf " | |  | | |  __/  __/ | | | | |  __/ \n"
    printf " |_|__|_|  \___|\___|_| |_|_|  \___| \n"
    printf " |  __ (_)   | |                     \n"
...
arch3=$(uname -a | grep -o 'x86_64' | head -n1)
...
#if [[ -e token.txt ]]; then
#    echo "Token instalado"
#else
#    echo "Token no hay token"
